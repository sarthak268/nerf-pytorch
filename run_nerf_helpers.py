...
class NeRF(nn.Module):
    def __init__(self, D=8, W=256, input_ch=3, input_ch_views=3, output_ch=4, skips=[4], use_viewdirs=False):
        ...
        self.pts_linears = [tcnn.Network(n_input_dims=63, n_output_dims=64, network_config=config["network"]), tcnn.Network(n_input_dims=256, n_output_dims=256, network_config=config["network"]), tcnn.Network(n_input_dims=256, n_output_dims=256, network_config=config["network"]), tcnn.Network(n_input_dims=64, n_output_dims=64, network_config=config["network"]), tcnn.Network(n_input_dims=64, n_output_dims=256, network_config=config["network"])]
